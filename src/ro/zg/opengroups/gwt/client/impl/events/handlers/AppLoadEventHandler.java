...
public class AppLoadEventHandler extends OpenGroupsUserEventHandler{

    public AppLoadEventHandler(OpenGroupsServiceAsync openGroupsService, UserEventToCommandMapper mapper) {
